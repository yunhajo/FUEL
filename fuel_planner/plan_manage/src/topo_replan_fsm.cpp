...
void TopoReplanFSM::init(ros::NodeHandle& nh) {
  ...
  bbox_sub_ = nh.subscribe<geometry_msgs::PoseArray>("pose_array_topic", 10, &TopoReplanFSM::bboxCallback, this);
  node_ = nh;
}

void TopoReplanFSM::bboxCallback(const geometry_msgs::PoseArray::ConstPtr& msg)
{
    ...
    ROS_INFO("Parameters set in topo replan: sdf_map/box_min_x = %f, sdf_map/box_min_y = %f, sdf_map/box_min_z = %f", 
             pose_min.position.x, pose_min.position.y, pose_min.position.z);
    ROS_INFO("Parameters set in topo replan: sdf_map/box_max_x = %f, sdf_map/box_max_y = %f, sdf_map/box_max_z = %f", 
