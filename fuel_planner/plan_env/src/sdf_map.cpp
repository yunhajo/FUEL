...
namespace fast_planner {
  ...
  void SDFMap::initMap(ros::NodeHandle& nh) {
    ...
    cout << "Set min max box boundaries in sdf_map" << endl;
  ...
  // bool SDFMap::setBoundingBoxCallback(plan_env::SetBoundingBox::Request &request, plan_env::SetBoundingBox::Response &response) {
